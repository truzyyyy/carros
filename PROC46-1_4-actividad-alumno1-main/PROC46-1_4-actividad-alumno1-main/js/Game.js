class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 180, y: height - 1330, image: obstacle2Image },
      { x: width / 2 + 280, y: height - 1830, image: obstacle2Image },
      { x: width / 2 - 240, y: height - 3330, image: obstacle2Image },
     
      { x: width / 2 - 180, y: height - 4330, image: obstacle2Image },
